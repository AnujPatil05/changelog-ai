    ...
    return (
        <div className="space-y-4">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <h2 className="text-lg font-medium text-zinc-500">Repositories</h2>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                {filteredRepos.map((repo) => (
                    <Link key={repo} href={`/dashboard/${repo}`}>
                        <Card className="hover:border-primary/50 transition-all cursor-pointer bg-card shadow-sm hover:shadow-md">
                ...
                {filteredRepos.length === 0 && (
                    <div className="col-span-full flex flex-col items-center justify-center py-16 border-2 border-dashed border-border rounded-xl bg-muted/50">
